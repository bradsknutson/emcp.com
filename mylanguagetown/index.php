	...
	<div id="container" class="mlt">
		...
		<div class="secondary-first">
			...
			<!-- 4 -->
					...
					<div id="div5" class="targetDiv" style="display:none;">
                        <p>My Language Town's Intermediate Series is the place to drop by for those students of Spanish in the mood for adventure. Fact or fiction, historical or contemporary, quick reads or longer novels, a war romance in Madrid or a tango-paced murder mystery in Buenos Aires&mdash;you get to choose!
</p>
					</div>
				</div>
        ...
        <div class="redefining">
            <div class="ninesixty paddingtop40 paddingbottom40">
                ...
                <h2 class="no-bottom">The power of teaching Spanish through songs</h2>
                ...
                <ul>
                    ...
                    <li>They can team up and compete among each other singing the songs with TPR (creative dance moves = bonus points)</li>
                    <li>Students can make music videos for the songs</li>
                    <li>Students can do gap-filling exercises and more</li>
                </ul>
