...
?>
	<div id="container" class="al-ca al-bc">
		<div class="vimeo-modal"></div>
		<div class="header-background-image al-bc-bg">
			<div id="topImg"></div>
		</div>
		...
		<div class="white-slice al-top-content">
			<div class="ninesixty">
                <div class="left-slice">
                    <img src="<?php echo $server; ?>lib/images/al-bc-kb.png" alt="Paradigm Keyboarding" />
                </div>
		...
		<div class="white-slice">
			<div class="ninesixty">
                <div class="left-slice">
                    <img src="<?php echo $server; ?>lib/images/al-bc-computerized-accounting.png" alt="Computerized Accounting" />
                </div>
                <div class="right-slice">
		...
		<div class="white-slice">
			<div class="ninesixty">
                <div class="left-slice">
                    <img src="<?php echo $server; ?>lib/images/al-bc-legal-studies.png" alt="Legal Studies" />
                </div>
                <div class="right-slice">
                    <h1>Legal Studies</h1>
