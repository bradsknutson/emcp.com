 <?php
	$custom_title = 'Biotechnology | ';
	include '../../../includes/header.php';
?>
	<div id="container" class="biotech">
			...
			<div class="ninesixty">
				<div class="conectate-left">
                    <div class="entry-title">
                        <h2 class="margintop0">Biotechnology: Science for the New Millennium, Second Edition &copy;2017</h2>
                        <h4>Comprehensive textbook and lab manual combination program, designed for introductory courses</h4>
                    </div>
                    ...
                    <p><a class="learn-more-link smaller-link" href="http://www.bioteched.com" target="_blank">“Contact the author</a></p>
				</div>
        ...
        <div class="biotech-features">
            <div class="ninesixty paddingtop40 paddingbottom40">
                <div class="featured-flipgrid-left">
 					<img src="<?php echo $server; ?>lib/images/biotech-kit.png" class="margintop15" alt="Biotechnology Kit" />
                </div>
                <div class="featured-flipgrid-right">
                    ...
                    <a class="learn-more-link smaller-link" href="<?php echo $server; ?>applied-learning/applied-science/biotechnology/buy-kit/">Buy It Now!</a>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
