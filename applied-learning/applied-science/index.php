 <?php 
	$custom_title = 'Applied Science | ';
	include '../../includes/header.php';
?>
	<div id="container" class="al-ca al-as">
		<div class="vimeo-modal"></div>
		<div class="header-background-image al-as-bg">
			<div id="topImg"></div>
		</div>
		...
		<div class="white-slice al-top-content">
			<div class="ninesixty">
                <div class="left-slice">
                    <img src="<?php echo $server; ?>lib/images/al-as-biotech.png" alt="Biotechnology" />
                </div>
                <div class="right-slice">
                    ...
                    <a class="learn-more-link" href="https://drive.google.com/file/d/0B2wIWFpktdtAeWZLUHVCeDZKOFk/view" target="_blank">Download a sample chapter from the text</a>
                    <p><a class="learn-more-link" href="http://joom.ag/nKrp">Download a sample chapter from the lab manual</a></p>
                </div>
