...
jQuery(document).ready(function ($) {
    ...
    $vimeoembed7 = '<iframe src="//player.vimeo.com/video/138627634?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><div class="vimeo-modal-close"></div>' + $modal;
	// Deustch Aktuell
    ...
    $(document).on('click','.texas-landing .top-slice .expandable-link', function(e) {
