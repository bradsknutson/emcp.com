...
jQuery(document).ready(function ($) {
	...
	// Passport video
	$vimeoembed = '<iframe src="//player.vimeo.com/video/92619011?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><div class="vimeo-modal-close"></div>' + $modal;
	// Avenue video
	...
	$('#topImg .play-button').hover(function() {
		$('.header-hero-hover').addClass('header-hero-dim');
	}, function() {
		$('.header-hero-hover').removeClass('header-hero-dim');
	});
	...
	clickVimeo('#topImg .play-button',$vimeoembed);
	clickVimeo('.avenue-play-button .play-button',$vimeoembed2);
	clickVimeo('.flipgrid-play-button .play-button',$vimeoembed3);
	hoverDim('.avenue-play-button .play-button','.avenue-play-button-hover-background','.flipgrid-play-button .play-button');
	hoverDim('.flipgrid-play-button .play-button','.flipgrid-play-button-hover-background','.avenue-play-button .play-button');
