...
<?php 
	$custom_title = 'Idaho | Mirrors & Windows | ';
...
.ui-accordion-content {
	...
	<div id="container" class="mw">
		<div class="header-background-image mw-id-bg">
			<div id="topImg">
			</div>
		</div>
	...
	<!-- NEW -->
		<div style="padding:10px 0;margin:0;background:#9E0C10;">
			<h2 style="font-size:34px;margin:15px 0 25px;text-align:center;color:#fff;">Top Reasons Mirrors & Windows is Perfect for Idaho Teachers</h2>
		</div>
        <div class="redefining no-bottom">
			...
			<!-- 3 -->
					<h3 class="showSingle" target="3"><strong>3. Integrated Language Arts Program Meets 6-12 Idaho Core Standards (CCSS) and College and Career Standards</strong></h2>
