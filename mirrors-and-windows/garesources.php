...
<?php 
	$custom_title = 'Georgia | Mirrors & Windows Resources | ';
	include '../includes/header.php';
?>
	<div id="container" class="mw">
		<div class="header-background-image mw-ga-bg-resources">
			<div id="topImg">
			<!--
	...
	<!-- Sample Chapters -->
		<div>
			<div class="ninesixty"><h3 style="margin-top:410px;">Hello Georgia ELA Teachers. If you are purchasing an English Language Arts Program, here are some resources 
			about EMC's Mirrors &amp; Windows: Connecting with Literature program.</h3></div>
		</div>
	...
	<!-- ESOL Support -->
        <div class="grey-slice" style="padding:25px 0 !important;">
            <div class="ninesixty">
                <h2>ESOL Support</h2>
                <p>Mirrors &amp; Windows also offers differentiated instruction to support students learning English as a new language by encouraging students to communicate in English and 
				demonstrate their academic, social and cultural proficiency. Classroom teachers can easily integrate differentiated instruction with the Georgia Performance Standards.
				</p>
                <div class="clearfix"></div>
            </div>
        </div>
