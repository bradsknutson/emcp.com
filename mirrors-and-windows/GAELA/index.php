...
<?php 
	$custom_title = 'Georgia | Mirrors & Windows | ';
...
.ui-accordion-content {
	...
	<div id="container" class="mw">
		<div class="header-background-image mw-ga-bg">
			<div id="topImg">
			</div>
		</div>
		<div class="header-top">
			<?php include '../../includes/nav-ga.php'; ?>
		</div>
	...
	<!-- NEW -->
		<div style="padding:10px 0;margin:0;background:#9E0C10;">
			<h2 style="font-size:34px;margin:15px 0 25px;text-align:center;color:#fff;">Top 10 Reasons Mirrors &amp; Windows is Perfect for Georgia Teachers</h2>
		</div>
            ...
            <div class="ninesixty paddingbottom40" style="margin-top:15px;">
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>1. Love of Literature</strong>
					</div>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>2. Digital Learning Technologies</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>3. Supports Georgia ESOL students</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>4. Meets All Georgia  English Language Arts Standards of Excellence</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
								<li>Mirrors &amp; Windows fully meets the GA CCSS</li>
								<li>Text is scaffolded to establish a staircase of increasing complexity in what students must be able to read and write so all students are ready for the demands of college and/or career level communication no later than the end of high school.</li>
								<li>Narrative and explanatory writing, as well as research are foundational to the program.</li>
								<li>EMC will assist the classroom teacher to build knowledge through content-rich nonfiction; reading, writing and speaking grounded in evidence from the text, both literary and informational; and regular practice with complex text and its academic language.</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>6. Scaffolded Close Reading</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>7. Range of Texts and Complexity</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>8. Integrated Language Arts</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>9. Comprehensive Assessments</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
				...
				<div class="expandable-box expandable-one">
					<div class="expandable-box-label">
						<span class="expandable-box-icon">+</span><strong>10. Best Value</strong>
					</div>
					<div class="expandable-box-content">
						<div class="hidden-content">
							<ul>
