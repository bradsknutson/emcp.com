...
<?php 
	$custom_title = 'Nevada | Mirrors & Windows | ';
...
.ui-accordion-content {
	...
	<div id="container" class="mw">
		<div class="header-background-image mw-nv-bg">
			<div id="topImg">
			</div>
		</div>
		<div class="header-top">
			<?php include '../../includes/nav-nv.php'; ?>
		</div>
		<div class="secondary-first">
			<div class="ninesixty">
				<div>
					...
					<a class="mw-buttons" href="http://pages.exacttarget.com/page.aspx?QS=38dfbe491fab00ea0bd27d5b75fd1bded8883597a84a7199e2717b98926d0625" target="_blank">Sample</a>
					&nbsp;&nbsp;
	...
	<!-- NEW -->
		<div style="padding:10px 0;margin:0;background:#9E0C10;">
			<h2 style="font-size:34px;margin:15px 0 25px;text-align:center;color:#fff;">Top Reasons Mirrors & Windows is Perfect for Nevada Teachers</h2>
		</div>
        <div class="redefining no-bottom">
			...
			<!-- 3 -->
					<h3 class="showSingle" target="3"><strong>3. Integrated Language Arts Program Meets 6-12 Nevada Academic Content Standards for Language Arts</strong></h2>
