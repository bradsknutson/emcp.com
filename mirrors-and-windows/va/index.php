...
<?php 
	$custom_title = 'Virginia | Mirrors & Windows | ';
...
.ui-accordion-content {
	...
	<div id="container" class="mw">
		<div class="header-background-image mw-va-bg">
			<div id="topImg">
			</div>
		</div>
		...
		<div class="secondary-first">
			<div class="ninesixty">
				<div>
					...
					<a class="mw-buttons" href="http://pages.exacttarget.com/page.aspx?QS=38dfbe491fab00ea1213cf5f7e1fd4238c11d2d35467b46e2d6f930af6656a96" target="_blank">Sample</a>
					&nbsp;&nbsp;
					<a class="mw-buttons" href="https://vimeo.com/138627634" target="_blank">Watch Video</a>
					&nbsp;&nbsp;
					<a class="mw-buttons" href="resources/" target="_blank">Resources</a>
				</div>
	...
	<!-- NEW -->
		<div style="padding:10px 0;margin:0;background:#9E0C10;">
			<h2 style="font-size:34px;margin:15px 0 25px;text-align:center;color:#fff;">Top Reasons Mirrors & Windows is Perfect for Virginia Teachers</h2>
		</div>
        <div class="redefining no-bottom">
			...
			<!-- 1 -->
					...
					<div id="div1" class="targetDiv" style="display:none;">
						...
						<ul>
							<li>The most Diverse Range of Literature and Informational Texts</li>
			...
			<!-- 3 -->
					<h3 class="showSingle" target="3"><strong>3. Integrated Language Arts Program Meets the English Standards of Learning and Curriculum Framework for Virginia Public Schools</strong></h2>
					<div id="div3" class="targetDiv" style="display:none;">
						<ul>
							<li>Wide range of reading strategies applied to a variety of literary and informational texts.</li>
			...
			<!-- 4 -->
					<h3 class="showSingle" target="5"><strong>4. Scaffolded Gradual Release of Responsibility Approach</strong></h2>
					<div id="div5" class="targetDiv" style="display:none;">
						<ul>
							...
							<li>Gradual Release uses scaffolding to model and apply close reading skills and strategies for comprehension and analysis.</li>
						</ul>
					</div>
			<!-- 5 -->
					<h3 class="showSingle" target="6"><strong>5. Range of Texts and Complexity</strong></h2>
					<div id="div6" class="targetDiv" style="display:none;">
						<ul>
                            <li><i>Mirrors & Windows</i> provides a wide range of text types within grade level text complexity levels – all in student textbook</li>
							...
							<li>EMC E-Library with over 300 literary and nonfiction texts</li>
						</ul>
					</div>
			<!-- 6 -->
					
					<h3 class="showSingle" target="4"><strong>6. Differentiated Instruction and ELL Support</strong></h2>
					<div id="div4" class="targetDiv" style="display:none;">
						<ul>
							<li>Differentiated Instruction support in Teacher's Edition</li>
							...
							<li>Oral Fluency Assessments in Assessment Guide</li>
							<li>Flipgrid<sup>&trade;</sup> online video discussion platform</li>
							<li>Avenue<sup>&trade;</sup> online video oral assessment</li>
							<li>Spanish language readers and novels for extended reading in the native language</li>
						</ul>
					</div>
			<!-- 7 -->
					<h3 class="showSingle" target="7"><strong>7. Comprehensive Assessments</strong></h2>
			...
			<!-- 8 -->
					<h3 class="showSingle" target="8"><strong>8. Best Service and Value</strong></h2>
					<div id="div8" class="targetDiv" style="display:none;">
						<ul>
							...
							<li>Best value: For one low price you will have a complete print and digital package including all print and digital supplements</li>
						</ul>
					</div>
				</div>
			</div>
