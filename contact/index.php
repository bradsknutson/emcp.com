...
?>
	<div id="container">
		...
		<div class="white contact">
			<div class="ninehundred">
				<h2>Find your local account manager</h2>
				<p class="topten">EMC is committed to providing you with the highest level of customer service to ensure your complete satisfaction with our textbook programs. Use our <a href="https://store.emcp.com/contact-us/local-account-manager-locator/">Account Manager Locator</a> to contact your local representative.</p>
				
				<h2>Technical support</h2>
				<p class="topten">Our Technical Support Department is available to our customers to answer questions pertaining to our software. Customers can reach Technical Support by:</p>
