		...
		<div class="header-background-image elpac-bg">
			<div id="topImg">
                <div class="tech-button-container">
                    <a class="technology-buttons elpac-login transition" href="http://emcp.onlinemlpa.com/" target="_blank">Login</a>
                    <img src="<?php echo $server; ?>lib/images/elpac-screen.png" alt="ELPAC" class="elpac-lp-img" />
                    <a class="elpac-button eb1 transition" href="http://store.emcp.com/elpac-cora-sample-task-french-1">Sample Reading Proficiency Assessment Task</a>
                    <a class="elpac-button eb2 transition" href="http://store.emcp.com/elpac-contextualized-listening-assessment">Sample Listening Proficiency Assessment Activity</a>
                    <a class="elpac-button eb3 transition" href="http://store.emcp.com/elpac-contextualized-writing-assessment-sample">Sample Writing Proficiency Aasessment Task</a>
                    <a class="elpac-button eb4 transition" href="http://store.emcp.com/elpac-contextualized-speaking-assessment-sample">Sample Speaking Proficiency Assessment Activity</a>
