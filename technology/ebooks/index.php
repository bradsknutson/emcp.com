		...
		<div class="header-background-image bookshelf-bg">
			<div id="topImg">
                <div class="tech-button-container">
                    <a class="technology-buttons bookshelf-demo transition" href="https://edu.emcp.com/ebook-samples" target="_blank" onClick="ga('send', 'event', 'Call To Action Button','click','Bookshelf Demo');">Demo</a>
