	...
	<div id="container" class="technology">
		...
		<div class="world-languages-title">
			<div class="ninehundred onesix fonttwenty">
				<h3>Meet our revolutionary technology</h3>
			</div>
		</div>
		...
		<div class="world-languages-left techlp-elpac">
			<div class="ninehundred no-top no-bottom">
				<div class="wl-content">
					...
					<p>Assess your students' Spanish, French, or German language proficiency with elpac. Choose from multi-level online assessments in reading, listening, writing, and speaking. All elpac assessments are ACTFL-aligned.</p>
				</div>
			</div>
		</div>
