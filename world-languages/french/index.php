<?php 
	$custom_title = 'French Language Programs | ';
		...
		<div class="wl-featured-first featured-french">
			<div class="ninehundred onesix">
				<div>
					...
					<a class="learn-more-link smaller-link" href="https://www.emcp.com/teb">Learn more</a>
				</div>
			</div>
		</div>
		<div class="ninehundred">
			<div class="sub-featured onesix black">
				<img src="<?php echo $server; ?>lib/images/symtalk-french.jpg" alt="Symtalk" />
				<h3>Symtalk</h3>
