		...
		<div class="secondary-first">
			<div class="ninesixty">
				...
				<div class="conectate-left">
                    <p class="no-top"><span class="bold">EMC School</span> is proud to present its exciting literature program, <span class="italic">Mirrors & Windows</span>. This seven-level program is built on a collection of rich, diverse, and timeless writings by renowned, award-winning authors.</p>
