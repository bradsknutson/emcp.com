	...
	<div id="container" class="mw">
		...
		<div class="secondary-first" style="margin-top:420px !important;">
			...
			<div class="ninesixty" style="padding-top:0px;">
				<p><span class="italic">“The Mirrors & Windows: Connecting with Literature program is uniquely designed to provide students with the context, skills, and understanding they’ll need to function in today’s interconnected world. Read more about the advantages of Mirrors & Windows and discover what sets our program apart!”

				</p>

				<ul>
					<li><strong>Differentiated Instruction and EL Support</strong><br />
						The <span class="italic">Mirrors &amp; Windows</span> program provides opportunities for differentiated instruction and extensive EL support, including...<a class="showLink learn-more-link" style="text-decoration:none;">READ MORE</a>
						<ul class="hideme">
					...
					The <span class="italic">Mirrors &amp; Windows</span> program is fully... <a class="showLink learn-more-link" style="text-decoration:none;">READ MORE</a>
						<div class="hideme">
		...
		<div class="banner-padding grey-slice">
			<div class="ninesixty">
				<div class="col-6">
					<h3 class="bold red">Meet Passport®</h3>
					<p>EMC's innovative digital learning environment is uniquely designed for your language arts classroom. Engage students in language arts with content, communication, and media literacy. Equip students with the skills needed to succeed in work and life in the 21st century.</p>
					<a class="learn-more-link" href="<?php echo $server; ?>technology/passport/">Learn More</a>
				</div>
				<div class="col-6">
					<img style="float: right;" src="<?php echo $server; ?>lib/images/ela-teacher.png" />
				</div>
				<div class="clearfix"></div>
...
<!-- NEW -->
		<div class="paddingtop20 paddingbottom20" style="line-height:1.9;">
            <div class="ninesixty">
								...
								<div class="accordions">
								  <div class="ninesixty paddingbottom40">
								    <div id="accordion" class="ui-accordion ui-widget ui-helper-reset" role="tablist">
								      <!-- 1 -->
								      <h3 class="showSingle ui-accordion-header ui-state-default ui-corner-all ui-accordion-icons" target="1" role="tab" id="ui-id-1" aria-controls="div1" aria-selected="false" aria-expanded="false" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span><strong>Program Components</strong></h3>
								      <div id="div1" class="targetDiv ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" style="display: none; height: 550px;" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="true">
								        <h3><strong>Program Components</strong></h3>
								        <div>
								      ...
								      <!-- 2 -->
								      <h3 class="showSingle ui-accordion-header ui-state-default ui-corner-all ui-accordion-icons" target="2" role="tab" id="ui-id-2" aria-controls="div2" aria-selected="false" aria-expanded="false" tabindex="-1"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span><strong>Integrated Literacy and Language Resources</strong></h3>
								      ...
								      <!-- 3 -->
								      <h3 class="showSingle ui-accordion-header ui-state-default ui-corner-all ui-accordion-icons" target="3" role="tab" id="ui-id-3" aria-controls="div3" aria-selected="false" aria-expanded="false" tabindex="-1"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span><strong>Teacher Resources for Planning and Assessment</strong></h3>
