	...
	<div id="container" class="ereaders">
		...
		<div class="secondary-first">
			<div class="ninesixty">
                ...
                <img class="ereaders-right-img" src="<?php echo $server; ?>lib/images/iPadeReaders-image.jpg" alt="eReader Features" style="margin:30px 30px 0 0;" />
                
                <p class="ereaders-larger">eReader Featured</p>
