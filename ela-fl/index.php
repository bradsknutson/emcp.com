...
?>
	<div id="container" class="mw">
		...
		<div class="header-background-image fl-header">
			<div id="topImg">
                <div class="header-hero-hover" onclick="location.href='https://www.emcp.com/language-arts/mirrors-windows/testimonials';" style="cursor: pointer;"></div>
			</div>
		</div>
			...
			<div class="ninesixty" style="padding-bottom:10px;padding-top:15px !important;">
				<div style="width:700px;margin:0 auto;">
					<p style="text-align:center;">
						<a class="mw-link" href="http://pages.exacttarget.com/elafl1819/" target="_blank" onClick="ga('send', 'event', 'Call To Action Button','click','MW Sample');" style="">Sample</a>
						&nbsp;&nbsp;
...
<!-- NEW -->
	...
	<!-- Correlations -->
		<div class="white-slice paddingtop20 paddingbottom20" style="line-height:1.9;">
            <div class="ninesixty">
                <h4>Florida ELA Correlations 2018</h4>
